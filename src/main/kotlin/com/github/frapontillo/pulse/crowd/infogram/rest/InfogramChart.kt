...
package com.github.frapontillo.pulse.crowd.infogram.rest
 ...
 * @param data          An {@link InfogramChartData}, containing all of the elements to render.
 ...
 * @author Francesco Pontillo
 */
public data class InfogramChartSheet(var header: Array<String?>? = null,
                                     var rows: Array<InfogramChartSheetRow?>? = null)
 ...
 * @author Francesco Pontillo
 */
public data class InfogramChartSheetRow(var data: Array<Any>? = null, var header: String? = null,
